...
|-------|------|-------------------|------------|
| Maekawa edge diffraction (+ multi-wall shortest-detour) | `diffraction.js` | Maekawa 1968; ISO 9613-2 §7.4; Pierce-Hadden wedge | **TODO (Dr. Chen).** Per-path shortest-detour (Phase B1, v=649) replaced the earlier parallel-sum; needs a written δ/IL/lit-zone derivation + re-audit confirmation. |
...
| Porch / arcade enclosure lift | `porch-enclosure.js` | Beranek semi-open; ISO 3382-1 | **TODO (Dr. Chen).** Enclosure factor + drive point (Chen E8/E9). |
