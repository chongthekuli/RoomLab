...
export default {
  ...
  surauStructure: {
    ...
    // corner of the building footprint. ~8.5 m tall. (Both NW and NE
    // are common in Malaysian vernacular; flipped from NE → NW
    // 2026-05-18 to match the user's preferred 3D camera orientation.)
    //
